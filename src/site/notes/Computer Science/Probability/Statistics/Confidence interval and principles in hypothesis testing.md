...
#### קביעת גודל המדגם
מ[[Computer Science/Probability/Statistics/Statistical inference basics#משפט הגבול המרכזי\|משפט הגבול המרכזי]] אנחנו יודעים של $n$ יש חישבות גבוהה בקביעת התפלגות הדגימה. וגם תהיה לו חשיבות בחישוב הסתברות ההכרעה המוטעית.
